...
* Rebuild data from original source: ftp://ftp.ncdc.noaa.gov/pub/data/swdi/stormevents/csvfiles/
* Clean the key data variables
* Proceed through my laid out steps
...
to be a faithful copy (or at least subset) of the [NOAA "Storm Events 
Database](" . For
